            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
              ...
              <div class="py-4">
                <div class="h-96 rounded-lg border-4 border-dashed border-gray-200">
                  <slot>This is where dashboard content will go</slot>
                </div>
              </div>
              <!-- /End replace -->
            </div>
...
import { CalendarIcon, ChartBarIcon, FolderIcon, HomeIcon, InboxIcon, UsersIcon, XMarkIcon } from '@heroicons/vue/24/outline'
...
const navigation = [
  ...
  { name: 'Brand', href: '/brand', icon: CalendarIcon, current: false },
  { name: 'Favorites', href: '/favorites', icon: InboxIcon, current: false },
]
