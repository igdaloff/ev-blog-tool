        ...
        <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-8">
          <div>
            ...
            <div>
              ...
              <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Scrybe helps nonprofits create content at a click of of a button...quickly.</p>
